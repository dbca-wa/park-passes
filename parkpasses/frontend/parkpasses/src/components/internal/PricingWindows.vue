  ...
  <div class="container" id="internalDash">
    ...
    <div class="tab-content" id="pills-tabContent">
      <div
        ...
        id="pills-pricing-windows"
        role="tabpanel"
        aria-labelledby="pills-pricing-windows-tab"
      >
        <FormSection
          :formCollapse="false"
          label="Pricing Windows"
          Index="pricing-windows"
        >
          <PricingWindowsDatatable
            ref="pricingWindowsDatatable"
            level="internal"
          />
        </FormSection>
      </div>
...
import PricingWindowsDatatable from "@/components/internal/datatables/PricingWindowsDatatable.vue";

export default {
  name: "InternalPricingWindowsDashboard",
  data() {
    let vm = this;
    return {
      accessing_user: null,
  ...
  methods: {
    tabClicked: function (param) {
      if (param == "pricing-windows") {
        this.$refs.pricingWindowsDatatable.adjustTableWidth();
      }
    },
