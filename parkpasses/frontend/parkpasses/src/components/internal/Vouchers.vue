  ...
  <div class="container" id="internalDash">
    ...
    <div class="tab-content" id="pills-tabContent">
      <div
        ...
        id="pills-vouchers"
        role="tabpanel"
        aria-labelledby="pills-vouchers-tab"
      >
        <FormSection
          :formCollapse="false"
          label="Vouchers"
...
import VouchersDatatable from "@/components/internal/datatables/VouchersDatatable";
...
export default {
  ...
  methods: {
    tabClicked: function (param) {
      if (param == "vouchers") {
        this.$refs.vouchers_table.adjustTableWidth();
        this.$refs.vouchers_referred_to_me_table.adjustTableWidth();
