  ...
  <div class="container" id="internalDash">
    ...
    <div class="tab-content" id="pills-tabContent">
      <div
        ...
        id="pills-discount-codes"
        role="tabpanel"
        aria-labelledby="pills-discount-codes-tab"
      >
        <FormSection
          :formCollapse="false"
...
import DiscountCodeBatchesDatatable from "@/components/internal/datatables/DiscountCodeBatchesDatatable";
...
export default {
  ...
  methods: {
    tabClicked: function (param) {
      if (param == "discountCodes") {
        this.$refs.discountCodeBatchDatatable.adjustTableWidth();
      }
    },
