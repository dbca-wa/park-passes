<template>
    <div class="modal fade" id="pricingWindowModal" tabindex="-1" aria-labelledby="pricingWindowModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form @submit.prevent="validateForm" @keydown.enter="$event.preventDefault()" class="needs-validation"
                    novalidate>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select @change="fetchDefaultOptionsForPassType" ref="passType" class="form-control"
                                :class="errors.pass_type ? 'is-invalid' : ''" v-model="pricingWindow.pass_type"
                                aria-describedby="validationServerPassTypeFeedback" required>
                                <option disabled value="0">Select a Pass Type</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" :class="errors.name ? 'is-invalid' : ''" id="name"
                                name="name" v-model="pricingWindow.name" aria-describedby="validationServerNameFeedback"
                                required />
                        ...
                        <div class="mb-3">
                            ...
                            <input @change="updateMinEndDate()" type="date" class="form-control"
                                :class="errors.date_start ? 'is-invalid' : ''" id="dateStart" name="dateStart"
                                v-model="pricingWindow.date_start" required="required" :min="defaultStartDate()"
                                aria-describedby="validationServerDateStartFeedback">
                            <div v-if="errors.date_start" id="validationServerDateStartFeedback"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" :class="errors.date_expiry ? 'is-invalid' : ''"
                                id="dateExpiry" name="dateExpiry" v-model="pricingWindow.date_expiry"
                                required="required" :min="minEndDate"
                                aria-describedby="validationServerDateExpiryFeedback">
                            <div v-if="errors.date_expiry" id="validationServerDateExpiryFeedback"
                                class="invalid-feedback">
                        ...
                        <div v-if="defaultPassOptions">
                            ...
                            <table v-if="defaultPassOptions && defaultPassOptions.length > 0"
                                    ...
                                    <tr v-for="(option, index) in defaultPassOptions">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="options"
                                                v-model="pricingWindow.pricing_options[index]" required="required" />
...
export default {
    ...
    methods: {
        ...
        validateForm: function () {
            ...
            if (0 == vm.pricingWindow.pass_type) {
                vm.$refs.passType.setCustomValidity("Invalid field.");
            } else {
                vm.$refs.passType.setCustomValidity("");
            }
