                ...
                <form @submit.prevent="validateForm" @keydown.enter="$event.preventDefault()" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" type="checkbox" id="makeAdmin" name="makeAdmin" :checked="getAdminDefault" :disabled="getAdminDefault"  aria-describedby="makeAdminHelpBlock">
                        </div>
...
export default {
    ...
    methods: {
        processApproval: function (approved) {
            ...
            vm.approval.is_admin = vm.getAdminDefault;
