<template>
    <div>
        <div class="row mb-3">
            <div class="col">
                <router-link class="btn licensing-btn-primary btn-lg float-end" tabindex="-1" role="button" to="invite-a-user">Invite a User</router-link>
            </div>
        </div>
    ...
    computed: {
        ...
        dtOptions: function(){
            ...
            return {
                ...
                bFilter:false,
                ajax: {
                    "url": apiEndpoints.retailerGroupUserListRetailer + '?format=datatables',
                    "dataSrc": 'data',
